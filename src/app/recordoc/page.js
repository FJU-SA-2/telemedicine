...
export default function AppointmentRecords() {
  ...
  const [isCancelling, setIsCancelling] = useState(false); // 取消請求中的狀態
  const [refundInfo, setRefundInfo] = useState(null); // 取消預約的退款資訊
        ...
        <div className="bg-white rounded-xl shadow-2xl p-6 w-full max-w-md mx-4 border border-gray-200">
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              className={`flex-1 font-medium py-2.5 rounded-lg transition ${
                isCancelling
